...
public class KonfigurasiSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/studiesActivity/khs/list").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_KPS", "VIEW_AKADEMIK2", "VIEW_DOSEN_AKADEMIK","VIEW_AKADEMIK1", "VIEW_STAFF")
...
//                return authorities;     // email user ini belum terdaftar di database
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring()
                ...
                .antMatchers("/request/mahasiswa/import/{nim}")
