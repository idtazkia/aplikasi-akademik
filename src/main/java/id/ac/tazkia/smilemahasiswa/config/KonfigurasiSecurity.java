...
public class KonfigurasiSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/mahasiswa/list").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK1", "VIEW_AKADEMIK2", "VIEW_STAFF", "VIEW_FINANCE","VIEW_DOSEN_AKADEMIK","VIEW_BEASISWA")
                ...
                .antMatchers("/studiesActivity/attendance/listdosen").hasAnyAuthority("VIEW_KPS", "VIEW_WAREK2", "VIEW_DOSEN", "VIEW_DOSEN_AKADEMIK")
                ...
                .antMatchers("/studiesActivity/assesment/listdosen").hasAnyAuthority("VIEW_KPS", "VIEW_DOSEN", "VIEW_WAREK2", "VIEW_DOSEN_AKADEMIK")
                .antMatchers("/studiesActivity/khs/list").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_KPS", "VIEW_AKADEMIK2", "VIEW_DOSEN_AKADEMIK","VIEW_AKADEMIK1", "VIEW_STAFF", "VIEW_KHS_ADMIN")
                .antMatchers("/studiesActivity/transcript/list").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_KPS", "VIEW_AKADEMIK2", "VIEW_AKADEMIK1", "VIEW_TRANSCRIPT_ADMIN","VIEW_BEASISWA")
                .antMatchers("/studiesActivity/transcript/cetaktranscript").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK2", "VIEW_AKADEMIK1","VIEW_BEASISWA")
                ...
                .antMatchers("/graduation/lecture/list").hasAnyAuthority("VIEW_DOSEN", "VIEW_KPS", "VIEW_WAREK2","VIEW_DOSEN_AKADEMIK")
                .antMatchers("/graduation/lecture/sempro").hasAnyAuthority("VIEW_DOSEN", "VIEW_KPS", "VIEW_WAREK2","VIEW_DOSEN_AKADEMIK")
                ...
                .antMatchers("/report/recapitulation/ipk").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK1","VIEW_AKADEMIK2", "VIEW_STAFF", "VIEW_DOSEN_AKADEMIK", "VIEW_KPS","VIEW_BEASISWA")
                .antMatchers("/report/historymahasiswa").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK1","VIEW_AKADEMIK2", "VIEW_STAFF", "VIEW_KPS", "VIEW_TRANSCRIPT_ADMIN", "SETTING_MESIN_ABSEN","VIEW_PEMBINA","VIEW_BEASISWA")
                .antMatchers("/report/cuti").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK1","VIEW_AKADEMIK2", "VIEW_STAFF", "VIEW_KPS")
                .antMatchers("/activation/krsdetail").hasAnyAuthority("VIEW_SUPERUSER")
                .antMatchers("/activation/sesi").hasAnyAuthority("VIEW_SUPERUSER")
                .antMatchers("/mahasiswa").hasAnyAuthority("VIEW_MAHASISWA_NUNGGAK")
                .antMatchers("/study/comingsoon").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/study/krs").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/du/form").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/du/cuti/form").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/studentBill/bill/list").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/report/khs").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/report/transcript").hasAnyAuthority("VIEW_MAHASISWA")
                .antMatchers("/graduation/register").hasAnyAuthority("VIEW_MAHASISWA")
...
//                return authorities;     // email user ini belum terdaftar di database
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring()
                ...
                .antMatchers("/api/rekap-absen-dosen")
                ...
                .antMatchers("/images/**")
                .antMatchers("/api/getlistTahunAkademik")
                .antMatchers("/api/getDetailJadwal")
                .antMatchers("/api/getKelas")
                .antMatchers("/api/apiGetKaryawan");
    }
