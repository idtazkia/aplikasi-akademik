...
public class KonfigurasiSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/equipment/class/list").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK2")
                ...
                .antMatchers("/setting/mahasiswa/dosen_wali").hasAnyAuthority("VIEW_SUPERUSER", "VIEW_AKADEMIK2")
