...
;(function( $ ){
    ...
    if ($('[data-ac-repeater]').length > 0){
        ...
        $('[data-ac-repeater]').each(function (i) {
            ...
            var repeaterText = elementToRepeat.attr('data-ac-repeater-text') ? elementToRepeat.attr('data-ac-repeater-text') : 'Tambah Pertanyaan';
            var adderId = 'acAdder' + i;
            var adder = '<br><button class="btn btn-warning btn-sm" id="'+adderId+'">'+repeaterText+'</button>'
