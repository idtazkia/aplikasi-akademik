...
CREATE TABLE ayah (
  ...
  id_pekerjaan varchar(255) DEFAULT NULL,
...
CREATE TABLE jadwal (
  ...
  id_prodi varchar(255) DEFAULT NULL,
  id_dosen_pengampu varchar(255) DEFAULT NULL,
...
CREATE TABLE mahasiswa (
  ...
  id_kota_kabupaten varchar(255) DEFAULT NULL,
  id_provinsi varchar(255) DEFAULT NULL,
  id_negara varchar(255) DEFAULT NULL,
  ...
  id_dosen_wali varchar(255) DEFAULT NULL,
  id_wali varchar(255) DEFAULT NULL,
  PRIMARY KEY (id)
);
...
CREATE TABLE sesi_kuliah (
  ...
  waktu_selesai datetime DEFAULT NULL,
  id_presensi_dosen varchar(255) DEFAULT NULL,
  PRIMARY KEY (id)
);
...
CREATE TABLE wali (
  ...
  id_jenjang_pendidikan varchar(255) DEFAULT NULL,
  id_pekerjaan varchar(255) DEFAULT NULL,
  id_penghasilan varchar(255) DEFAULT NULL,
  id_agama varchar(255) DEFAULT NULL,
  status varchar(10) DEFAULT NULL,
